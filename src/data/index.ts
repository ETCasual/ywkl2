...
export const jsonData: Record<string, Record<string, any>> = {
  "connect-camp": {
    ...
    emergencyContacts: [
      ...
      { name: "Chi Joon", contact: "+6016-3286960", type: "general" },
    ],
    pic: [
      {
        name: "Json Low",
    ...
    booklet: {
      ...
      groups: {
        ...
        调查兵团: {
          ...
          12: [
            "Nicholas Yee Weng Liang (L)",
            "Aiden Chew Yu Zhe (AL)",
            "Chan Ern Jiet",
            "Tai Min Yi",
            "Chong Tein Yan",
            "Chin Zhi Cong",
        ...
        驻守兵团: {
          ...
          6: [
            "Priscilla Lua Sim Yee (L)",
            "Cheng Zhi Mei (AL)",
            "Jordan Ang Siu Leong (AL)",
            "Pooi Weng Been",
            "Cheong Jia Le",
            "Foong Hong Seng",
            "Chan Pui Ni",
